...
config :digga, DiggaWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "rLV5eYNo55lNeVFwAP8u3K3XOkqllUAvfQhPdjmHyniKPEKrEG/v2Ejf38bfaPuY",
  watchers: [
...
config :digga, DiggaWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/digga_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :digga, dev_routes: true
