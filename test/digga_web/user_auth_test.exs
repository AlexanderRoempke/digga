defmodule DiggaWeb.UserAuthTest do
  use DiggaWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Digga.Users
  alias DiggaWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, DiggaWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      DiggaWeb.Endpoint.subscribe(live_socket_id)
