defmodule Digga.UserIdentitiesFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Digga.UserIdentities` context.
  """

  import Digga.UsersFixtures

  alias Digga.UserIdentities
  ...
  def user_identity_fixture(%User{} = user, attrs) do
    ...
    {:ok, user_identity} = Digga.UserIdentities.create_user_identity(user, attrs)
