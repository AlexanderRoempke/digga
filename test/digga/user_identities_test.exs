defmodule Digga.UserIdentitiesTest do
  use Digga.DataCase

  import Digga.UsersFixtures
  import Digga.UserIdentitiesFixtures

  alias Digga.UserIdentities
  alias Digga.UserIdentities.UserIdentity
  ...
  describe "find_or_create_user with a new user_identity" do
    test "find_or_create_user/1 it returns ok-account-tuple" do
      ...
      assert {:just_created, %Digga.Users.User{email: "new_user@example.com"}} =
