defmodule Digga.OneOffsTest do
  use Digga.DataCase

  alias Digga.OneOffs
  alias Digga.OneOffs.Task

  import Digga.OneOffsFixtures
  ...
  describe "tasks" do
    ...
    test "execute/0 executes the test task" do
      ...
      assert [%Task{module: "Digga.OneOffsTest.TestTask"}] = OneOffs.list_tasks()
      assert_received :task_executed
    end

    test "execute/0 does not execute the test task if its in the database" do
      task_fixture(%{module: "Digga.OneOffsTest.TestTask"})
