defmodule Digga.UsersTest do
  use Digga.DataCase

  alias Digga.Users

  import Digga.UsersFixtures
  alias Digga.Users.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "creates the personal account" do
      ...
      assert %Digga.Accounts.Account{personal: true} = user.personal_account
      assert [%Digga.Accounts.Membership{role: :owner}] = user.memberships
    end
  end
