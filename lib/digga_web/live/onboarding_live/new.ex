defmodule DiggaWeb.OnboardingLive.New do
  @moduledoc """
  ...
  alias Digga.Onboarding
  alias Digga.Accounts

  import DiggaWeb.AccountOnboarding, only: [get_next_step: 1]
  ...
  def get_component(step) do
    case step.key do
      "step-2" -> DiggaWeb.OnboardingLive.StepTwo
      "step-3" -> DiggaWeb.OnboardingLive.StepThree
      _ -> DiggaWeb.OnboardingLive.StepOne
    end
  end
