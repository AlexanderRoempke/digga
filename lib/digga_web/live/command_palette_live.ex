defmodule DiggaWeb.Live.CommandPaletteLive do
  @moduledoc """
  ...
  <%= live_render(
    ...
    DiggaWeb.Live.CommandPaletteLive,
  ...
  alias DiggaWeb.CommandPalette
  alias DiggaWeb.CommandPalette.Format
  alias DiggaWeb.CommandPalette.Result
