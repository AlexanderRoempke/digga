defmodule DiggaWeb.Admin.SessionController do
  use DiggaWeb, :controller

  import Digga.Admins.GenerateAdmin
  alias Digga.Admins
  alias Digga.Admins.Guardian

  plug DiggaWeb.Plugs.RedirectAdmin when action in [:new, :create]
