defmodule Digga.Accounts do
  ...
  alias Digga.Accounts.Account
  alias Digga.Accounts.Membership
  alias Digga.Accounts.Member
  alias Digga.Accounts.Invitation
  ...
  use Phoenix.VerifiedRoutes, endpoint: DiggaWeb.Endpoint, router: DiggaWeb.Router
  alias Digga.Mailer
  alias Digga.Accounts.InvitationNotifier
