defmodule Digga.Campaigns do
  ...
  alias Digga.Campaigns.Membership
  alias Digga.Campaigns.Receipt
  alias Digga.Campaigns.ExecuteStepWorker
  ...
  def get_campaign_module(:campaign_only_used_in_test), do: Digga.CampaignsTest.TestCampaign
  def get_campaign_module("campaign_only_used_in_test"), do: Digga.CampaignsTest.TestCampaign
  ...
  def not_in_campaign_query(query, campaign) do
    in_campaign_subquery = from(
      m in Digga.Campaigns.Membership,
