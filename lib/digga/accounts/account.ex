defmodule Digga.Accounts.Account do
  @moduledoc """
  The Account Schema
  """
  use Digga.Schema
  ...
  schema "accounts" do
    ...
    belongs_to :created_by, Digga.Users.User, foreign_key: :created_by_user_id
  ...
  defp maybe_require_onboarding(changeset, attrs) do
    required? = Map.get(attrs, :onboarding_required, Application.get_env(:digga, :onboarding_required))
